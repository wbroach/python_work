...
class User():
    ...
    def show_privileges(self):
        show_privileges_input = input("Show privileges? (y or n) ")
        
        if show_privileges_input == 'y':
            for i in self.privileges.privileges_user:
                print("\t- " + i.title())
...
class Admin(User):
    ...
    def show_privileges(self):
        ...
        if show_privileges_input == 'y':
            for i in self.privileges.privileges_admin:
                print("\t- " + i.title())
...
class Privileges():
    """ """
    def __init__(self):
        self.privileges_admin = ['can add post', 'can edit post', 
        'can delete post', 'can ban user']
        self.privileges_user = ['can add post', 'can edit post', 
